...
public class GlobalValue : MonoBehaviour
{
    ...
    public static int SavedNewCoins
    {

        get { return PlayerPrefs.GetInt("SavedNewCoins", 0); }
        set { PlayerPrefs.SetInt("SavedNewCoins", value); }
    }
    ...
    {
        get { return PlayerPrefs.GetInt("SavedLive", 0); }
    ...
    public static int Bullets
    {
        get
        {
            int bullets = PlayerPrefs.GetInt("Bullets", 2);
            return bullets;
        }
